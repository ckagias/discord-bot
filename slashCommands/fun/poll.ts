...
function buildBar(votes: number, total: number) {
...
function buildEmbed(question: string, options: string[], votes: Map<string, unknown[]>, hostTag: string, endsAt: Date | null, ended: boolean) {
...
function buildButtons(options: string[], disabled = false) {
...
async function closePoll(client: Client, pollId: unknown) {
