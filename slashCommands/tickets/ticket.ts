import { SlashCommandBuilder, PermissionFlagsBits, ChannelType, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, MessageFlags, ChatInputCommandInteraction } from 'discord.js';
...
module.exports = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        if (sub === 'close') {
            ...
            const isSupport = (interaction.member.permissions as any).has(PermissionFlagsBits.ManageChannels);
