...
function makeInteraction({ sub, role = null, threshold = null, window = null, enabled = null, member = null }: { sub?: string; role?: any; threshold?: number | null; window?: number | null; enabled?: boolean | null; member?: any } = {}) {
    return {
        options: {
