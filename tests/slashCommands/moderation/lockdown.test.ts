...
function makeInteraction({ sub, reason = null, hasOverwrites = true, alreadyLocked = false }: { sub: string; reason?: string | null; hasOverwrites?: boolean; alreadyLocked?: boolean }) {
