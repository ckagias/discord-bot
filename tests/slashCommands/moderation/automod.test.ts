...
function makeInteraction({ sub, group = null, name = null, type = null, duration = null, word = null, count = null }: { sub?: string; group?: string | null; name?: string | null; type?: string | null; duration?: string | null; word?: string | null; count?: number | null } = {}) {
    return {
        options: {
