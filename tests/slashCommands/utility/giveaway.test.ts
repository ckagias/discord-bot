...
function makeInteraction({ sub, prize = 'Nitro', duration = '10m', winners = null, requireRole = null, messageId = 'msg1' }: { sub: string; prize?: string; duration?: string; winners?: number | null; requireRole?: any; messageId?: string }) {
    return {
        options: {
