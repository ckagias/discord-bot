...
function makeInteraction({ sub, duration = '10m', message = 'test reminder', id = 'r1', hasGuild = true }: { sub: string; duration?: string; message?: string; id?: string; hasGuild?: boolean }) {
    return {
        options: {
