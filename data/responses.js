...
module.exports = {
    ...
    truths: [
        ...
        "What's a rumour about you that was completely true?",
        ...
        "What's a lie you told your parents that you never got caught for?",
        "What's the most unhinged thing you've done for attention?",
        "Have you ever pretended to like a gift you hated?",
        "What's the cringiest thing you used to post online?",
        "What's a habit you have that you'd never admit to in person?",
        "Who was your most toxic friendship and why?",
        "What's the last thing you lied about in this server?",
        "What screenshot on your phone would ruin your life if leaked?",
        "What's the most embarrassing thing you've searched in your browser history?",
    ],
    ...
    dares: [
        ...
        "Text your crush 'I can't stop thinking about you' with no context.",
        "Let the group pick your Discord status for the next hour.",
        "Speak only in questions for the next three rounds.",
        "Do your best impression of another member of the group until someone guesses who.",
        "Change your Discord nickname to whatever the group decides for the next 10 minutes.",
        "Draw a portrait of the person to your left with your non-dominant hand.",
        "Recite the alphabet backwards as fast as you can.",
        "Let the group rename one of your files or folders.",
        "Send the group your most recent camera roll photo, no matter what it is.",
        "Hold a plank for as long as the group counts out loud.",
    ],
    ...
    workResponses: [
        ...
        { text: "You mowed lawns around the neighbourhood.", min: 90, max: 190 },
        { text: "You did a photography gig for a local event.", min: 180, max: 320 },
        { text: "You mod'd a Discord server for the weekend.", min: 60, max: 140 },
        { text: "You flipped a thrifted item for a profit online.", min: 110, max: 260 },
        { text: "You babysat for a neighbour on short notice.", min: 100, max: 210 },
        { text: "You did some freelance video editing for a client.", min: 190, max: 380 },
        { text: "You washed cars in a parking lot all afternoon.", min: 80, max: 170 },
        { text: "You picked up a delivery shift during peak hours.", min: 150, max: 320 },
        { text: "You fixed someone's PC for cash.", min: 120, max: 260 },
        { text: "You busked downtown and people actually tipped.", min: 40, max: 200 },
    ],
